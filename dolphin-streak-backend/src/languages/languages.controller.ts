...
export class LanguagesController {
  ...
  @ApiOperation({
    summary: "Upload a language's thumbnail",
    description:
      "Is used to upload a language's thumbnail. Sorry that no body example in here, i don't know how",
  })
  ...
  @ApiOkResponse({
    description: "Return the uploaded language's thumbnail URL",
    example: {
      messages: 'Language Thumbnail uploaded successfully',
      data: {
