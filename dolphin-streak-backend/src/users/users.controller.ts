...
export class UsersController {
  ...
  @Get(":id")
  async findOne(@Param() findOneParam: FindOneByIdParam) {
    return await this.usersService.findOne(findOneParam.id);
  }
  ...
  async update(
    ...
    return await this.usersService.update(findOneParam.id, updateUserDto);
  }
