...
// // // Import custom bubble menu and link bubble menu
...
//   // Note: The 'insertTable' method does not exist on 'SingleCommands'.
//   // You may need to add a custom command or use a different method.
//   const addTable = () => {
//     // editor.commands.insertTable({ rows: 3, cols: 3, withHeaderRow: true });
//     console.error(
//       "insertTable method not found. Please implement or use a different method."
//     );
//   };
...
//         </Button>
//       </div>
//       <div className="p-4 min-h-[200px] max-w-none">
