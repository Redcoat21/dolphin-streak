...
import { ZLoginInput, ZRegisterInput, ZUpdateLanguagePreferencesInput, ZForgotPasswordInput, ZResetPasswordInput, ZRefreshAccessTokenRequest, ZUpdateProfileInput, ZUpdateProfilePictureInput, ZPostSubscribeRequest, ZChangePasswordInput } from '../types/auth';
...
export const authRouter = router({
  ...
  changePassword: publicProcedure.input(ZChangePasswordInput).mutation(async ({ input }) => {
